...
ConvolutionInqLayer<Dtype>::ConvolutionInqLayer(
...
template <typename Dtype>
void ConvolutionInqLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void ConvolutionInqLayer<Dtype>::Backward_cpu(
...
#ifdef CPU_ONLY
STUB_GPU(ConvolutionInqLayer);
#endif

INSTANTIATE_CLASS(ConvolutionInqLayer);
REGISTER_LAYER_CLASS(ConvolutionInq);
