...
FcInqLayer<Dtype>::FcInqLayer(const LayerParameter& param)
      : InnerProductLayer<Dtype>(param), BaseInqLayer<Dtype>() {
...
template <typename Dtype>
void FcInqLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void FcInqLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_CLASS(FcInqLayer);
REGISTER_LAYER_CLASS(FcInq);
